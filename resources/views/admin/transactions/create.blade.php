            ...
            <form action="{{ route('transactions.pos.save') }}" method="POST" id="pos-form">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="card glass-card">
                            <div class="card-body p-4">
                                <h6 class="section-title"><i class="bi bi-info-circle"></i> Informasi Transaksi & Jadwal Lab
                                </h6>
                                <div class="row g-3">
                                    <div class="col-md-4">
                                        <label class="form-label">No Faktur</label>
                                        <input type="text" name="no_transaksi" class="form-control form-control-sm bg-light"
                                            value="{{ \App\Models\Transaction::generateNomor() }}">
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="no_legalisasi" class="form-control form-control-sm"
                                            placeholder="Input no. legalisasi...">
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="catatan" class="form-control form-control-sm" rows="1"
                                            placeholder="Catatan untuk laboratorium atau faset..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <div class="input-group input-group-sm position-relative">
                                            <input type="text" name="no_bpjs" id="ac_no_bpjs" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="asal_resep" class="form-control form-control-sm"
                                            placeholder="Dokter/Klinik...">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table table-sm table-borderless align-middle mb-0 text-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="text" name="od_sph"
                                                        class="form-control form-control-sm text-center border-0 bg-light rounded-pill px-2"
                                                        placeholder="0.00"></td>
                                                <td><input type="text" name="od_cyl"
                                                        class="form-control form-control-sm text-center border-0 bg-light rounded-pill px-2"
                                                        placeholder="0.00"></td>
                                                <td><input type="text" name="od_axis"
                                                        class="form-control form-control-sm text-center border-0 bg-light rounded-pill px-2"
                                                        placeholder="0"></td>
                                                <td><input type="text" name="od_add"
                                                        class="form-control form-control-sm text-center border-0 bg-light rounded-pill px-2"
                                                        placeholder="0.00"></td>
                                                <td><input type="text" name="od_mpd"
                                                        class="form-control form-control-sm text-center border-0 bg-light rounded-pill px-2"
                                                        placeholder="0.0"></td>
                                            </tr>
                                            <tr>
                                                <td class="fw-bold text-danger">OS</td>
                                                <td><input type="text" name="os_sph"
                                                        class="form-control form-control-sm text-center border-0 bg-light rounded-pill px-2 mt-1"
                                                        placeholder="0.00"></td>
                                                <td><input type="text" name="os_cyl"
                                                        class="form-control form-control-sm text-center border-0 bg-light rounded-pill px-2 mt-1"
                                                        placeholder="0.00"></td>
                                                <td><input type="text" name="os_axis"
                                                        class="form-control form-control-sm text-center border-0 bg-light rounded-pill px-2 mt-1"
                                                        placeholder="0"></td>
                                                <td><input type="text" name="os_add"
                                                        class="form-control form-control-sm text-center border-0 bg-light rounded-pill px-2 mt-1"
                                                        placeholder="0.00"></td>
                                                <td><input type="text" name="os_mpd"
                                                        class="form-control form-control-sm text-center border-0 bg-light rounded-pill px-2 mt-1"
                                                        placeholder="0.0"></td>
                                            </tr>
                                        </tbody>
                    ...
                    <div class="col-lg-3">
                                ...
                                <div id="product-items">
                                    <div class="product-item row g-3">
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group input-group-sm position-relative">
                                                <input type="text" name="kode_frame[]" class="form-control ac-kode-produk"
                                                    autocomplete="off" placeholder="Cari kode produk...">
                                                <button class="btn btn-outline-primary" type="button"><i
                                                        class="bi bi-search"></i></button>
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="harga_satuan[]"
                                                class="form-control form-control-sm harga-satuan" placeholder="0" readonly>
                                        </div>
                                    </div>
                                </div>

                                <div class="mt-3 d-flex gap-2 justify-content-between">
                                    <button type="button" class="btn btn-sm btn-success" id="btn-add-to-cart"><i
                                            class="bi bi-cart-plus"></i> Tambah</button>
                                    <button type="button" class="btn btn-sm btn-primary" id="btn-open-cart"><i
                                            class="bi bi-cart"></i> Keranjang (<span id="cart-count">0</span>)</button>
                                </div>
                                ...
                                <template id="product-item-template">
                                    <div class="product-item row g-3 mt-3">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" name="kode_produk_display[]"
                                                class="form-control form-control-sm" placeholder="Kode produk..." readonly>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Nama Produk</label>
                                            <input type="text" name="nama_produk[]" class="form-control form-control-sm"
                        ...
                        <div class="card glass-card finance-card border-0 shadow-lg">
                            <div class="card-body p-4">
                                <h6 class="section-title text-white"><i class="bi bi-cash-stack"></i> Rincian Pembayaran
                                </h6>

                                <div
                                    class="mb-3 p-3 bg-white bg-opacity-10 rounded-3 border border-white border-opacity-25">
                                    <label class="form-label text-white d-block mb-2 text-center text-uppercase">Tipe
                                        Transaksi</label>
                                    <div class="gap-4 justify-content-center">
                                        <div class="form-check">
                                            <input class="form-check-input border-white" type="radio" name="typefaktur"
                                                id="tunai" value="1" checked>
                                            <label class="form-check-label small text-white" for="tunai">Tunai /
                                                Umum</label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input border-white" type="radio" name="typefaktur"
                                ...
                                <div class="row g-3">
                                    <div class="col-12">
                                        ...
                                        <div class="input-group input-group-sm">
                                            ...
                                            <input type="text" name="harga_jual" class="form-control text-end fs-6"
                                                value="0">
                                        </div>
                                    </div>
                                    <div class="col-12">
                                    ...
                                    <div class="col-12 mt-4 pt-3 border-top border-white border-opacity-25">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <span
                                                class="input-group-text bg-danger bg-opacity-25 border-0 text-white fw-bold">Rp</span>
                                            <input type="text" name="sisa"
                                                class="form-control text-end bg-danger bg-opacity-25 text-white fw-bold"
                                                readonly value="0">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="card glass-card p-3 shadow-lg border-primary border-opacity-25 bg-white bg-opacity-75">
                    <div class="d-flex flex-wrap justify-content-center gap-2">
                        ...
                        <button type="submit" class="btn btn-action btn-success shadow-sm" id="btn-simpan"><i
                                class="bi bi-save"></i> Simpan</button>
                        <button type="button" class="btn btn-action btn-primary shadow-sm" onclick="openPrintModal()"><i
                                class="bi bi-printer"></i> Cetak</button>
                        <button type="button" class="btn btn-action btn-warning text-white shadow-sm"
                            onclick="resetForm()"><i class="bi bi-arrow-clockwise"></i> Reset</button>
                        <button type="button" class="btn btn-action btn-danger shadow-sm" onclick="deleteTransaction()"><i
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content glass-modal border-0">
                ...
                <div class="modal-body text-center pb-4">
                    <p class="text-muted mb-4 small">Pilih format cetak. Sistem akan langsung mengirim perintah cetak ke
                        Kiosk / printer.</p>
                    <div class="d-grid gap-2 col-8 mx-auto">
                        ...
                        <button class="btn btn-outline-secondary btn-action justify-content-center mt-2"
                            onclick="doPrint('bon_1_rangkap')"><i class="bi bi-receipt"></i> Cetak Bon Standar (1
                            Rangkap)</button>
                    </div>
                </div>
            </div>
...
@push('scripts')
    ...
    <script>
        ...
        function initProductAutocomplete(el) {
            ...
            setupAutocompleteInput(el, dd, '{{ route('products.frame.autocomplete') }}',
                ...
                (f, input) => {
                    ...
                    const productIdInput = rowel.querySelector('input[name="product_id[]"]');
                    if (productIdInput) productIdInput.value = f.id || '';
                    const kodeProdDisplay = rowel.querySelector('input[name="kode_produk_display[]"]');
                    if (kodeProdDisplay) kodeProdDisplay.value = f.kode_produk || '';
        ...
        function fillForm(trx) {
            ...
            const setVal = (parent, selector, value) => {
                let el = parent.querySelector(selector);
                if (el) el.value = value;
            };

            setVal(fm, 'input[name="no_transaksi"]', trx.no_transaksi);
            setVal(fm, 'input[name="no_legalisasi"]', trx.no_legalisasi || '');
            setVal(fm, 'input[name="tgl_legalisasi"]', trx.tgl_legalisasi || '');
            setVal(fm, 'input[name="tgl_order"]', trx.tgl_order || '{{ date('Y-m-d') }}');
            setVal(fm, 'input[name="tgl_faset"]', trx.tgl_faset || '');
            setVal(fm, 'input[name="lab"]', trx.lab || '');
            setVal(fm, 'input[name="tempat_faset"]', trx.tempat_faset || '');
            setVal(fm, 'input[name="tgl_datang_faset"]', trx.tgl_datang_faset || '');
            setVal(fm, 'input[name="tgl_selesai_faset"]', trx.tgl_selesai_faset || '');
            setVal(fm, 'input[name="tgl_selesai_janji"]', trx.tgl_selesai_janji || '');
            setVal(fm, 'textarea[name="catatan"]', trx.catatan || '');

            // Items & Patient Data overrides
            setVal(fm, 'input[name="no_bpjs"]', trx.patient ? trx.patient.no_bpjs : (trx.no_bpjs || ''));
            setVal(fm, 'input[name="nama"]', trx.patient ? trx.patient.nama : (trx.nama_pasien || ''));
            setVal(fm, 'textarea[name="alamat"]', trx.patient ? trx.patient.alamat : (trx.alamat_pasien || ''));
            setVal(fm, 'input[name="telp"]', trx.patient ? trx.patient.no_hp : (trx.telp_pasien || ''));
            setVal(fm, 'input[name="asal_resep"]', trx.asal_resep || '');

            setVal(fm, 'input[name="lensa"]', trx.lensa || '');
            ...
            if (firstProduct) {
                setVal(firstProduct, 'input[name="kode_frame[]"]', trx.kode_frame || '');
                setVal(firstProduct, 'input[name="kode_produk_display[]"]', trx.kode_frame || '');
                setVal(firstProduct, 'input[name="nama_produk[]"]', trx.nama_produk || (trx.items && trx.items.length ? trx.items[0].nama_produk : ''));
                setVal(firstProduct, 'input[name="keterangan[]"]', trx.keterangan_frame || '');
                setVal(firstProduct, 'input[name="seri[]"]', trx.seri || '');
                setVal(firstProduct, 'input[name="warna[]"]', trx.warna || '');
                setVal(firstProduct, 'input[name="harga_satuan[]"]', trx.items && trx.items.length ? formatRibuan(trx.items[0].harga_satuan) : '0');
            }
            ...
            ['od_sph', 'od_cyl', 'od_axis', 'od_add', 'od_mpd', 'os_sph', 'os_cyl', 'os_axis', 'os_add', 'os_mpd'].forEach(f => {
                let rInput = fm.querySelector(`input[name="${f}"]`);
                if (rInput) rInput.value = trx[f] || '';
            });
        ...
        function resetForm() {
            ...
            if (firstProduct) {
                const clearVal = (sel) => { let el = firstProduct.querySelector(sel); if (el) el.value = ''; };
                clearVal('input[name="kode_frame[]"]');
                clearVal('input[name="kode_produk_display[]"]');
                clearVal('input[name="product_id[]"]');
                clearVal('input[name="nama_produk[]"]');
                clearVal('input[name="seri[]"]');
                clearVal('input[name="warna[]"]');
                clearVal('input[name="keterangan[]"]');
                clearVal('input[name="harga_satuan[]"]');
            }
